...
<div id="container">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body" id="enroll-division">
	      	<button id="member-enroll-btn" type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target=".member-enroll-end">일반 회원</button>
	...
	<!-- 일반회원 가입 modal -->
	<div class="modal fade member-enroll-end" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	      ...
	      <div class="modal-body member-enroll-modal" id="enroll-division">
		      <form action="${pageContext.request.contextPath}/member/insertMember.do" id="member-enrollFrm" method="post">
			      ...
			      <input type="text" name="memberName" id="member-enroll-name"/><br />
			      <label for="member-enroll-password">비밀번호</label>
			      <input type="password" name="memberPwd" id="member-enroll-password"/><br />
			      <span id="s-password"></span>
			      <label for="member-enroll-password_">비밀번호 확인</label>
			      <input type="password"  id="member-enroll-password_"/><br />
			      <label for="member-enroll-phone">전화번호</label>
			      <input type="text" name="phone" id="member-enroll-phone"/><br />
			  </form>
	      </div>
	      <div class="modal-footer">
	      	<button type="button" id="member-enroll-end-btn" class="btn btn-primary">회원가입</button>
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">닫기</button>
	      </div>
	    </div>
	  </div>
	...
	<script>
		$(function(){
			...
			$("input#agent-enroll-password_").blur(function(){
		           ...
		           if(bool != true){
		        	   $("span#s-password").text("비밀번호가 일치하지 않습니다.");
					   $("span#s-password").css("color", "red");
