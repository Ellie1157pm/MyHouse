...
​
	<tr>
			<th>매물정보</th>
			<td><input type="radio" name="estateType" id="apt" value="A" checked="checked" />
...
​
		...
		<tr id="oneroom" style="display:none;">
			...
			<input type="radio" name="construction" id="one2"  value="분리형(방1거실1)" />
			...
			<input type="radio" name="construction" id="off2"  value="분리형원룸" />
			<label for="off2"  >분리형원룸 </label>
				<input type="radio" name="construction" id="off3"  value="복층형원룸" />
			<label for="off3">복층형원룸</label>
					<input type="radio" name="construction" id="off4"  value="투룸" />
			<label for="off4">투룸</label>
					<input type="radio" name="construction" id="off5"  value="쓰리룸" />
