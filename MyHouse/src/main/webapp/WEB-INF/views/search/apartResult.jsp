...
function getDetailEstate(placeName,placeAddressName,estateNo,x,y){
	...
	//스크롤 걸린거 제거위해
	$("#sidebar").unbind();
		var memberNo = $("input#loggedInMemberNo").val();
		 ...
		 //ajax를 사용해서 서블릿에서 해당하는 매물의 상세정보를 가져온다.
		   $.ajax({
		   	...
		   	success:function(data){
		   		...
		   		else html+="<span style='float:right;'><img id='cartImg' src='${pageContext.request.contextPath}/resources/images/search/filled.jpg' onclick=\"deleteCart('"+estateNo+"', '"+memberNo+"')\"; style='cursor:pointer; width:30px; height:30px;'>"; 
		   		html+="</div>";
		   		html+="<div id='imgBox'>";
