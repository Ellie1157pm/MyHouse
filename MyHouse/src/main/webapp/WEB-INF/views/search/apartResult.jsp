...
<div id="searchArea">
	...
	<div id="search3">
		...
		<button type="button" class="btn btn-secondary first" value="M" data-type="매매" data-value="checked" onclick="changeDeal2(this);" style="background:#6c757d;color:white;">매매</button>
		...
		<table id="areaTbl">
			<tr>
				...
				<td  ><button type="button" class="btn btn-secondary second" data-type="10평 이하" value="1" onclick="changeARea(this);">10평이하</button></td>
				<td  ><button type="button" class="btn btn-secondary second" data-type="10평대" value="10" onclick="changeARea(this);";">10평대</button></td>
				<td  ><button type="button" class="btn btn-secondary second" data-type="20평대" value="20" onclick="changeARea(this);";">20평대</button></td>
			</tr>
			<tr>
				<td ><button type="button" class="btn btn-secondary second" value="30" data-type="30평대" onclick="changeARea(this);";">30평대</button></td>
				<td   ><button type="button" class="btn btn-secondary second" value="40" data-type="40평대"  onclick="changeARea(this);";">40평대</button></td>
				<td  ><button type="button" class="btn btn-secondary second" value="50" data-type="50평대"  onclick="changeARea(this);";">50평대</button></td>
				<td   ><button type="button" class="btn btn-secondary second" value="60" data-type="60평 이상"  onclick="changeARea(this);";">60평 이상</button></td>
        ...
        var infowindow = new kakao.maps.InfoWindow({
         ...
         kakao.maps.event.addListener(markers[0], 'click', function(mouseEvent) {
            ...
            $.ajax({
            	...
            	success: function(data){
            		console.log(data);
            		$("#imgBox").html("<img src=${pageContext.request.contextPath}/resources/upload/"+data.estatePhoto.renamedFileName+"/>");
            		$("#floating").html("<button type='button' class='btn btn-warning' onclick=\"showEstate("+data.detailEstate.EstateNo+",'"+place.address_name+"','"+place.road_address_name+"');\">매물보기</button>");
