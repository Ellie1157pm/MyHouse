...
<div id="search-container-div">
	...
	<div id="search-input">
		<input type="search" id="insertSearchKeyword"
			onchange="searchAddress(this);" placeholder="먼저 종목을 선택해주세요" /> <input
